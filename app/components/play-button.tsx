...
export function PlayButton({ tokenId }: PlayButtonProps) {
  ...
  return (
    <button
      onClick={handlePlay}
      disabled={isLoading}
      className="px-4 w-full text-2xl font-bold py-8 bg-blue-500 text-white rounded-md hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
    >
